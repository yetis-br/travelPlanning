...
// AccessLogTPApiMiddleware produces the access log following a format inspired by Apache
...
type AccessLogTPApiMiddleware struct {
...
// MiddlewareFunc makes AccessLogTPApiMiddleware implement the Middleware interface.
func (mw *AccessLogTPApiMiddleware) MiddlewareFunc(h rest.HandlerFunc) rest.HandlerFunc {
...
func (mw *AccessLogTPApiMiddleware) convertFormat() {
...
func (mw *AccessLogTPApiMiddleware) executeTextTemplate(util *accessLogUtil) string {
